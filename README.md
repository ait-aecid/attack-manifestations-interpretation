...
For example, Step 4 of Scenario 1 is a web scanning attack; check out the plots in the `state_charts` directory for a list of all attack steps. You can find the logs corresponding to that attack step as follows:
